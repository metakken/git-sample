...
<?php
    if (isset($_POST['l4'])) {
        ...
        $_SESSION['license_id'] = 2;
    }else if (isset($_POST['l1'])){
        $_SESSION['license_id'] = 1;
    }
?>
        ...
        <div class="container">
            <div id="menu">
                <ul>
                    ...
                    <li><a href="r_license.php">関連資格</a></li>
                    <li><a href="all_license.php">資格一覧</a></li>
                    <li><a href="d_license.php">資格診断</a></li>
                </ul>
            </div>
            ...
            <?php
                ...
                <div class="main_function">
                    ...
                    <div>
                        ...
                        <div class="license_detail2">
                            <div class="center">上位資格：</div>
                            <div class="margin_r"><?= $view13 ?></div>
                            <div class="license_data2">
                            <style>
                                .hide{display:none;}
                            </style>
                            <?php
