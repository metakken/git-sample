            ...
            <div class="main">
                ...
                <div>
                    ...
                    <div class="license_detail4">
                        <div class="center">更新情報サイトURL：</div>
                        <div class="margin_r">
                        <input type="button" value="✓更新" onclick="changeFlag(<?=$p_license['license_id']?>,'<?=$p_license['achieve_flag']?>')">

                        <input type="button" value="条件追加" onclick="addTerm(<?=$p_license['license_id']?>,'<?=$p_license['update_term1']?>','<?=$p_license['update_term2']?>','<?=$p_license['update_term3']?>','<?=$p_license['update_term4']?>','<?=$p_license['update_term5']?>','<?=$p_license['update_term6']?>','<?=$p_license['update_term7']?>','<?=$p_license['update_term8']?>','<?=$p_license['update_term9']?>','<?=$p_license['update_term10']?>')">

                        <input type="button" value="条件更新" onclick="changeText(<?=$p_license['license_id']?>,'<?=$p_license['update_term1']?>','<?=$p_license['update_term2']?>','<?=$p_license['update_term3']?>','<?=$p_license['update_term4']?>','<?=$p_license['update_term5']?>','<?=$p_license['update_term6']?>','<?=$p_license['update_term7']?>','<?=$p_license['update_term8']?>','<?=$p_license['update_term9']?>','<?=$p_license['update_term10']?>')">
                        <br>

                        <button id="1" onclick="deleteTerm(this.id,'<?=$p_license['license_id']?>','<?=$p_license['update_term1']?>','<?=$p_license['update_term2']?>','<?=$p_license['update_term3']?>','<?=$p_license['update_term4']?>','<?=$p_license['update_term5']?>','<?=$p_license['update_term6']?>','<?=$p_license['update_term7']?>','<?=$p_license['update_term8']?>','<?=$p_license['update_term9']?>','<?=$p_license['update_term10']?>')">削除1</button>
                        <button id="2" onclick="deleteTerm(this.id,'<?=$p_license['license_id']?>','<?=$p_license['update_term1']?>','<?=$p_license['update_term2']?>','<?=$p_license['update_term3']?>','<?=$p_license['update_term4']?>','<?=$p_license['update_term5']?>','<?=$p_license['update_term6']?>','<?=$p_license['update_term7']?>','<?=$p_license['update_term8']?>','<?=$p_license['update_term9']?>','<?=$p_license['update_term10']?>')">削除2</button>
                        <button id="3" onclick="deleteTerm(this.id,'<?=$p_license['license_id']?>','<?=$p_license['update_term1']?>','<?=$p_license['update_term2']?>','<?=$p_license['update_term3']?>','<?=$p_license['update_term4']?>','<?=$p_license['update_term5']?>','<?=$p_license['update_term6']?>','<?=$p_license['update_term7']?>','<?=$p_license['update_term8']?>','<?=$p_license['update_term9']?>','<?=$p_license['update_term10']?>')">削除3</button>
                        <button id="4" onclick="deleteTerm(this.id,'<?=$p_license['license_id']?>','<?=$p_license['update_term1']?>','<?=$p_license['update_term2']?>','<?=$p_license['update_term3']?>','<?=$p_license['update_term4']?>','<?=$p_license['update_term5']?>','<?=$p_license['update_term6']?>','<?=$p_license['update_term7']?>','<?=$p_license['update_term8']?>','<?=$p_license['update_term9']?>','<?=$p_license['update_term10']?>')">削除4</button>
                        <button id="5" onclick="deleteTerm(this.id,'<?=$p_license['license_id']?>','<?=$p_license['update_term1']?>','<?=$p_license['update_term2']?>','<?=$p_license['update_term3']?>','<?=$p_license['update_term4']?>','<?=$p_license['update_term5']?>','<?=$p_license['update_term6']?>','<?=$p_license['update_term7']?>','<?=$p_license['update_term8']?>','<?=$p_license['update_term9']?>','<?=$p_license['update_term10']?>')">削除5</button>
                        <button id="6" onclick="deleteTerm(this.id,'<?=$p_license['license_id']?>','<?=$p_license['update_term1']?>','<?=$p_license['update_term2']?>','<?=$p_license['update_term3']?>','<?=$p_license['update_term4']?>','<?=$p_license['update_term5']?>','<?=$p_license['update_term6']?>','<?=$p_license['update_term7']?>','<?=$p_license['update_term8']?>','<?=$p_license['update_term9']?>','<?=$p_license['update_term10']?>')">削除6</button>
                        <button id="7" onclick="deleteTerm(this.id,'<?=$p_license['license_id']?>','<?=$p_license['update_term1']?>','<?=$p_license['update_term2']?>','<?=$p_license['update_term3']?>','<?=$p_license['update_term4']?>','<?=$p_license['update_term5']?>','<?=$p_license['update_term6']?>','<?=$p_license['update_term7']?>','<?=$p_license['update_term8']?>','<?=$p_license['update_term9']?>','<?=$p_license['update_term10']?>')">削除7</button>
                        <button id="8" onclick="deleteTerm(this.id,'<?=$p_license['license_id']?>','<?=$p_license['update_term1']?>','<?=$p_license['update_term2']?>','<?=$p_license['update_term3']?>','<?=$p_license['update_term4']?>','<?=$p_license['update_term5']?>','<?=$p_license['update_term6']?>','<?=$p_license['update_term7']?>','<?=$p_license['update_term8']?>','<?=$p_license['update_term9']?>','<?=$p_license['update_term10']?>')">削除8</button>
                        <button id="9" onclick="deleteTerm(this.id,'<?=$p_license['license_id']?>','<?=$p_license['update_term1']?>','<?=$p_license['update_term2']?>','<?=$p_license['update_term3']?>','<?=$p_license['update_term4']?>','<?=$p_license['update_term5']?>','<?=$p_license['update_term6']?>','<?=$p_license['update_term7']?>','<?=$p_license['update_term8']?>','<?=$p_license['update_term9']?>','<?=$p_license['update_term10']?>')">削除9</button>
                        <button id="10" onclick="deleteTerm(this.id,'<?=$p_license['license_id']?>','<?=$p_license['update_term1']?>','<?=$p_license['update_term2']?>','<?=$p_license['update_term3']?>','<?=$p_license['update_term4']?>','<?=$p_license['update_term5']?>','<?=$p_license['update_term6']?>','<?=$p_license['update_term7']?>','<?=$p_license['update_term8']?>','<?=$p_license['update_term9']?>','<?=$p_license['update_term10']?>')">削除10</button>
                        </div>
                    </div>
