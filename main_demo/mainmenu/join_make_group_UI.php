...
<html lang="ja">
	...
	<form action="join_group.php" method="post">
		...
		<label>グループID:</label><input type="text" name="group_join_id" placeholder="参加したいグループのＩＤを入力" required><br>
		<label>パスワード:</label><input type="password" name="group_join_pass" placeholder="参加したいグループのパスワードを入力" required><br>
	...
	<form action="make_group.php" method="post">
		...
		<label>グループ名:</label><input type="text" name="group_name" placeholder="作成したいグループの名前を入力" required><br>
		<label>グループID:</label><input type="text" name="group_id" placeholder="作成したいグループのＩＤを入力" required><br>
		<label>パスワード:</label><input type="password" name="group_pass" placeholder="作成したいグループのパスワードを入力" required><br>
